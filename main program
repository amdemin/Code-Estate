    ...
    try:
        ...
        while num < 4:
            ...
            if 10 <= sum_day <= 31:
                ...
                sum_day = sum_day - 31
                data2 = "2019-" + str(key+1) + "-" + "0" + str(sum_day)
            elif sum_day < 10:
                data2 = year_month + str(sum_day) # здесь изначально было "0" + str(sum_day), но месяц октябрь двузначный
...
# apihelper.proxy = {'https': '37.187.21.85:3128'}
